package com.ticket.tiqeet.tiqeet.com.ticket.tiqeet.DatabaseModels;
...
public class User {
    ...
    public static Dao<com.ticket.tiqeet.DatabaseModels.User, Integer> userDao ;
    ...
    static public com.ticket.tiqeet.DatabaseModels.User getThisUser(){
        try {
            List<com.ticket.tiqeet.DatabaseModels.User> userList = userDao.queryBuilder().where().eq("isThisUser", true).query();
    ...
    static public List<com.ticket.tiqeet.DatabaseModels.User> getUsers(){
        try {
            List<com.ticket.tiqeet.DatabaseModels.User> userList = userDao.queryBuilder().query();
            return userList ;
        } catch ( Exception e) {
            e.printStackTrace();
            //Log.e(TAG,  + "> doesnt exist in db") ;
    ...
    static public com.ticket.tiqeet.DatabaseModels.User getUser(String id){
        try {
            List<com.ticket.tiqeet.DatabaseModels.User> userList = userDao.queryBuilder().where().eq("userId", id).query();
            return userList.get(0) ;
        } catch ( Exception e) {
            //e.printStackTrace();
            //Log.e(TAG, id + "> doesnt exist in db") ;
            com.ticket.tiqeet.DatabaseModels.User newUser = new com.ticket.tiqeet.DatabaseModels.User() ;
            newUser.userId = id ;
            return newUser;
        }
    ...
    public static boolean deleteAllUsers(){
        DeleteBuilder<com.ticket.tiqeet.DatabaseModels.User, Integer> deleteBuilder = userDao.deleteBuilder();
        try {
